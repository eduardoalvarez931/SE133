...
class ChordEditor extends Component {
  constructor(props) {
    super(props);
    //"this" is ChordEditor within constructor method.
    this.handleChange = this.handleChange.bind(this);
    this.state = { value: 'Type some lyrics here' };
  }

  handleChange(e) {
      //over rides and changes state
    this.setState({ value: e.target.value });
  }

  //everytime a change is made, getChordMarkup is called
  getChordMarkup() {
    //variables formatter, parser, and song are initialized
      ...
      <div className="chord-editor">
        ...
        <div className="panel">
          ...
          <div
            ...
            //dangerouslySetInnerHTML react provides this to set raw html.
